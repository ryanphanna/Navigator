...
export const DetailHeader: React.FC<DetailHeaderProps> = ({
    ...
    return (
        <div className="border-b border-neutral-200 dark:border-neutral-800 sticky top-0 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-md z-10">
            <div className="mx-auto px-6 py-4 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-black text-neutral-900 dark:text-white truncate max-w-md tracking-tight" title={title}>
                            {title}
                        </h2>
                        {subtitle && (
