...
import { Calendar, Building, ArrowRight, Trash2, Loader2, AlertCircle, Send, Users, Star, XCircle } from 'lucide-react';
...
const History: React.FC<HistoryProps> = ({ jobs, onSelectJob, onDeleteJob }) => {
    ...
    return (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4">
            <h2 className="text-lg font-semibold text-slate-900 mb-6">Application History</h2>
